...
@sz.on_message(filters.command(["help", f"help@Emo_Logo_Bot"]))
@ForceSub
...
@sz.on_message(filters.command(["about", f"about@Emo_Logo_Bot"]))
@ForceSub
...
@sz.on_message(filters.command(["ping", f"ping@Emo_Logo_Bot"]))
@ForceSub
